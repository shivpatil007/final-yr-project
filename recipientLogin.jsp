    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="">Recipient</a>
            <ul>
 ...
 <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          ...
          <div class="col-md-6 pr-md-5">
            <form action="RecipientLoginServlet" method="post">
            <h2 class="mb-0">Recipent Login</h2><br>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                     <span class="btn btn-primary py-3 px-2">New user?  <a href="sponserLogin.jsp">Register here</a></span>  
              </div>
            </form>
